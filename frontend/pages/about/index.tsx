...
const AboutPage: NextPage = () => {
  return (
    <Container>
      ...
      <Body>
        アニメやマンガなどを愛してやまない<BlankA href="https://twitter.com/_mogaming">管理人のmoga</BlankA>
        が常々感じていた「このアニメの続きは一体何巻から読めるんだ！？」という不満をほんの少し和らげられたらいいなと思って開発されたサービスです。
        <BlankA href="https://annict.jp/">Annict様</BlankA>
        のご厚意によりご提供いただいたアニメのデータ、管理人や利用者の皆様が入力した原作情報により支えられています。このサービスによって、少しでも物語を創り出す方々に貢献できれば嬉しいです。
      </Body>

      <SectionTitle>収益について</SectionTitle>
      <Body>このサービスによって得られれた収益はすべて、サービス運用費と原作購入費にあてられます。</Body>
